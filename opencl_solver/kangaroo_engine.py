...
STEPS_BATCH = 64       # hops between affine conversions
...
MAX_DP_OUT  = 262144   # max DP results per kernel call
...
class KangarooEngine:
    ...
    def __init__(self, pubkey,   # tuple or None
        ...
        if use_mb:
            ...
            mb_dp = 14  # Otimizado para RX 6600
            self.dp_bits = mb_dp
            ...
            self._mb_steps = STEPS_CALL  # 2048 hops/call
        else:
